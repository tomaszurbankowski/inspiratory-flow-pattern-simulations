...
Simulation scripts, parameter-sweep outputs, and figure-generation code for analyses of regional inspiratory energy routing in heterogeneous lung models
